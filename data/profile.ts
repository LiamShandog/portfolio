...
export const profile: Profile = {
  ...
  bio: [
    ...
    "Right now I'm the Perception Manager on the Queen's Aerospace Design Team, directing a 15-member team building the C++ and Python software stack for a fixed-wing autonomous drone competing in the advanced class of the SAE Aero 2027 design competition. I manage a GitHub organization and a Dockerized Ubuntu 24.04 build system that gives every contributor consistent cross-platform development across macOS, Windows, and Linux. On the perception side I'm developing a computer vision stack, implementing physical AI world models and training a YOLO object-detection model to identify specified task ground targets from a ZED 3D depth-sensing camera mid-flight.",
    "Before that I was a Software Developer at Cavtera, where I built a full-stack equipment management system in TypeScript and React that surfaced idling equipment worth $1,000,000+ a year in recoverable cost, shipped automated alerts that increased utilization across 1,000+ trucks and pieces of equipment, restored live telematics by fixing broken ingestion APIs and rebuilding a Python transform pipeline handling 10,000+ records a day, modeled the business as a Palantir Foundry ontology, and shipped the operator-facing front end on Foundry's Ontology SDK. Earlier, at Thomas Cavanagh Construction Limited, I digitized dispatch for a 100+ driver fleet — custom software that cut 4+ hours of daily dispatcher calls and dozens of spreadsheets by modeling fleet data in an ontology, delivered as Foundry Workshop applications backed by Python transforms, with local caching that dropped compute costs from $100+/week to single digits.",

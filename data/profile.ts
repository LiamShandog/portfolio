...
export const profile: Profile = {
  ...
  bio: [
    ...
    "Right now I'm the Automation Manager on the Queen's Aerospace Design Team, directing a 15-member team building the C++ and Python software stack for a fixed-wing autonomous drone competing in the advanced class of the SAE Aero 2027 design competition. I manage a GitHub organization and a Dockerized Ubuntu 24.04 build system that gives every contributor consistent cross-platform development across macOS, Windows, and Linux, and I'm implementing Nvidia's Cosmos physical AI model and training a YOLO object-detection model to identify task ground targets from a ZED 3D depth-sensing camera mid-flight.",
